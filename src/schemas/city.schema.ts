...
class CitySchema {
  public checkCreateCity(): ValidationChain[] | any {
    return [
      ...
      body('countryId')
        .notEmpty()
        .withMessage('The country id should not be empty')
        .isUUID(4)
        .withMessage('The country id should be a UUID v4')
        .custom(async value => {
          if (value) {
            const country = Country.findByPk(value);

            if (!country) {
              return Promise.reject('This country does not exist');
            }
          }
        }),
      body('city')
      ...
      body('latitude')
        .notEmpty()
        .withMessage('The latitude value should not be empty')
        .isString()
        .withMessage('The latitude should be a string'),
      body('longitude')
        .notEmpty()
        .withMessage('The longitude value should not be empty')
        .isString()
        .withMessage('The longitude should be a string'),
      body('region')
        .notEmpty()
